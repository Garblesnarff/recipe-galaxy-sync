...
INSERT INTO exercise_library (name, description, muscle_groups, equipment, difficulty, category, instructions, is_custom) VALUES
  ('Push-ups', 'Classic upper body exercise', ARRAY['Chest', 'Triceps', 'Shoulders'], ARRAY['Bodyweight'], 'Beginner', 'Strength', 'Start in plank position. Lower your body until chest nearly touches floor. Push back up.', false),
  ('Squats', 'Fundamental lower body exercise', ARRAY['Quadriceps', 'Glutes', 'Hamstrings'], ARRAY['Bodyweight'], 'Beginner', 'Strength', 'Stand with feet shoulder-width apart. Lower body as if sitting back into a chair. Return to standing.', false),
  ('Plank', 'Core stability exercise', ARRAY['Core', 'Shoulders'], ARRAY['Bodyweight'], 'Beginner', 'Core', 'Hold your body in a straight line from head to heels, supported on forearms and toes.', false),
  ('Burpees', 'Full body cardio exercise', ARRAY['Full Body'], ARRAY['Bodyweight'], 'Intermediate', 'Cardio', 'From standing, drop to plank, do a push-up, jump feet to hands, then jump up with arms overhead.', false),
  ('Lunges', 'Lower body strength and balance', ARRAY['Quadriceps', 'Glutes', 'Hamstrings'], ARRAY['Bodyweight'], 'Beginner', 'Strength', 'Step forward with one leg, lowering hips until both knees bent at 90 degrees. Return to start.', false),
  ('Bench Press', 'Upper body pushing exercise', ARRAY['Chest', 'Triceps', 'Shoulders'], ARRAY['Barbell', 'Bench'], 'Intermediate', 'Strength', 'Lie on bench, lower barbell to chest, then press up to full arm extension.', false),
  ('Deadlift', 'Posterior chain compound movement', ARRAY['Back', 'Glutes', 'Hamstrings'], ARRAY['Barbell'], 'Advanced', 'Strength', 'With barbell on ground, hinge at hips to grip bar, then stand up straight by extending hips and knees.', false),
  ('Pull-ups', 'Upper body pulling exercise', ARRAY['Back', 'Biceps'], ARRAY['Pull-up Bar'], 'Intermediate', 'Strength', 'Hang from bar with palms facing away, pull yourself up until chin over bar, lower with control.', false),
  ('Mountain Climbers', 'Dynamic core and cardio exercise', ARRAY['Core', 'Shoulders'], ARRAY['Bodyweight'], 'Beginner', 'Cardio', 'From plank position, alternately drive knees toward chest in a running motion.', false),
  ('Dumbbell Rows', 'Back strengthening exercise', ARRAY['Back', 'Biceps'], ARRAY['Dumbbells'], 'Beginner', 'Strength', 'Bent over with one hand supported, pull dumbbell to hip while keeping elbow close to body.', false),
  ('Bicycle Crunches', 'Oblique-focused ab exercise', ARRAY['Core', 'Obliques'], ARRAY['Bodyweight'], 'Beginner', 'Core', 'Lying on back, bring opposite elbow to opposite knee in a cycling motion.', false),
  ('Jump Rope', 'Cardiovascular endurance', ARRAY['Full Body', 'Calves'], ARRAY['Jump Rope'], 'Beginner', 'Cardio', 'Jump over rope as it passes under feet, maintaining steady rhythm.', false),
  ('Shoulder Press', 'Overhead pressing movement', ARRAY['Shoulders', 'Triceps'], ARRAY['Dumbbells'], 'Beginner', 'Strength', 'Press dumbbells overhead from shoulder height to full arm extension.', false),
  ('Russian Twists', 'Rotational core exercise', ARRAY['Core', 'Obliques'], ARRAY['Bodyweight'], 'Beginner', 'Core', 'Seated with feet elevated, rotate torso side to side, optionally holding weight.', false),
  ('Box Jumps', 'Explosive lower body exercise', ARRAY['Quadriceps', 'Glutes', 'Calves'], ARRAY['Plyo Box'], 'Intermediate', 'Plyometric', 'Jump onto elevated platform, landing softly with bent knees. Step down and repeat.', false);
